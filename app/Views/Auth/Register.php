        ...
        <div class="row">
            <div class="col-6 bg-warning offset-3 p-3 rounded-2 mt-3">
                ...
                <h4>Regsiter</h4>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Password Confr</label>
                        <input type="password" class="form-control" name="password_confrtion" id="exampleInputPassword1">
                    </div>
